...
type ReportItem = { sku: string; name: string; sales30: number; sales90: number; dailyDemand: number; localStock: number; inbound: number; supplierStock: number; daysCover: number | null; reorderPoint: number; targetStock: number; suggestedOrder: number; status: 'order_now' | 'top_up' | 'covered'; lastSoldAt: string | null };
